...
import { 
  LogIn, Mail, Lock, Phone, Sparkles, Leaf, ArrowRight, 
  ShieldCheck, RefreshCw, KeyRound, CheckCircle2, X
} from 'lucide-react';
        ...
        {showGoogleModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
            <motion.div
              ...
              className="w-full max-w-sm p-6 rounded-3xl glass-card border border-brand-500/30 shadow-2xl space-y-4"
            >
