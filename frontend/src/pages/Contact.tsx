      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
          ...
          <div className="p-6 rounded-3xl glass-card border border-brand-500/20 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-gray-900 dark:text-white">contact@foodrescueai.org</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-brand-500/10 text-brand-600 dark:text-brand-400 flex items-center justify-center">
              ...
              <div>
                <p className="text-xs text-gray-500">Call Dispatch Center</p>
                <p className="text-xs font-bold text-gray-900 dark:text-white">+1 (800) 555-RESCUE</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-brand-500/10 text-brand-600 dark:text-brand-400 flex items-center justify-center">
              ...
              <div>
                <p className="text-xs text-gray-500">Global HQ</p>
                <p className="text-xs font-bold text-gray-900 dark:text-white">San Francisco, CA & Bangalore, IN</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleSubmit} className="p-8 rounded-3xl glass-card border border-brand-500/20 space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">Subject</label>
              <input
                type="text"
                required
