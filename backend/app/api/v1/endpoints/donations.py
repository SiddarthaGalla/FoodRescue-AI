...
def calculate_fare(donation: dict, volunteer_lat: float, volunteer_lng: float) -> tuple[float, dict]:
    ...
    # Distance fare
    v_lat = volunteer_lat if volunteer_lat is not None else 13.0827
    v_lng = volunteer_lng if volunteer_lng is not None else 80.2707
    donor_lat = donation.get("latitude") if donation.get("latitude") is not None else 13.0418
    donor_lng = donation.get("longitude") if donation.get("longitude") is not None else 80.2341
...
MOCK_DONATIONS_DB = {
    "mock-don-1": {
        ...
        "address": "No. 45, South Boag Road, T. Nagar, Chennai, Tamil Nadu 600017",
        "latitude": 13.0418,
        "longitude": 80.2341,
    ...
    "mock-don-2": {
        ...
        "address": "Rajiv Gandhi Salai (OMR), Sholinganallur, Chennai, Tamil Nadu 600119",
        "latitude": 12.9010,
        "longitude": 80.2279,
    ...
    "mock-don-3": {
        ...
        "expiryDateTime": now_base + timedelta(hours=2, minutes=30),
    ...
    "mock-don-4": {
        ...
        "claimedBy": "mock-ngo-id",
        "claimedByName": "Mylapore Shelter Hub",
        "assignedVolunteerId": "mock-vol-id",
        "assignedVolunteerName": "Driver Fleet #402 (Karthik R.)",
